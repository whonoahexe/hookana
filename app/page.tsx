...
import { ArrowDown, ArrowUpRight, DollarSign, Globe, User } from "lucide-react"
  ...
  return (
    <div>
      ...
      <section className="bg-secondary">
        ...
        <div className="mx-auto flex max-w-360 justify-center px-6 py-20 md:py-24">
          <section className="relative w-full max-w-180 bg-neutral-100 px-8 py-14 md:px-19 md:py-16 lg:px-30">
            <div className="mx-auto max-w-138">
              ...
              <p className="mt-5 max-w-137.75 font-mono text-xs leading-3.5 text-blue-500">
                We&apos;ll review your brand, build 2 sample concepts, and walk
                you through them on a quick call.
              </p>
            </div>
        ...
        {/* Footer */}
        <footer className="type-monospaced flex flex-col items-center justify-center gap-4 py-20 text-primary-foreground uppercase">
          <p className="max-w-122 text-center">
            CREATIVE PRODUCTION FOR PERFORMANCE MARKETERS WHO REFUSE TO
            COMPROMISE.
          </p>
